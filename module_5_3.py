...
# Это, в том числе может служить ограничением для сложения только наших экземпляров и хорошим способом
# (через принудительный вызов ошибки) запрещать сложение экземпляра нашего класса с встроенным типом данных.
